...
<html>
	<head>
		...
		<link rel="stylesheet" type="text/css" href="./styles/styles_answer_sheet_temp.css"></script>
	...
	<body>
		...
		<div class="container">
			<!--div class="content"-->
				<div class="column" id="questionGrid">
					<h1 style="padding-top:20px">Questions</h1>
					<table id='series'>
						<?php
							$numQuestions = getOption('answerkey','numQuestion');
				...
				<div class="column" id="answerChoices">
